    ...
    <div class="container py-8 md:py-12">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 text-sm">
            ...
            <div class="col-span-1 lg:col-span-3">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 md:gap-4">
                    ...
                    <div>
                        ...
                        <div class="flex flex-col gap-3 md:gap-4">
                            <a href="tel:021-38893041" class="hover:text-primary transition-colors">
                                <span class="font-medium">Phone:</span> 021-38893041
                            </a>
                            ...
                            <p class="hover:text-primary transition-colors">
                                <span class="font-medium">Location:</span> Palem Ganda Asri 1 blok A3 No.8, Karang
                                Tengah, Tangerang
                            </p>
                            <div class="flex items-center gap-4">
                                <a href="#" class="text-primary transition-colors">
            ...
            <div class="col-span-1 lg:col-span-2 w-full md:min-h-[300px] aspect-square bg-gray-100 rounded-lg">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1408.556576617501!2d106.70792028216876!3d-6.219710641935568!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f9f7cc10a6bb%3A0xed4a4fa7ece172d0!2sJl.%20Palem%20Ganda%20Asri%20Blok%20C2%20No.1%208%2C%20Karang%20Tengah%2C%20Kec.%20Karang%20Tengah%2C%20Kota%20Tangerang%2C%20Banten%2015157!5e0!3m2!1sid!2sid!4v1744912985211!5m2!1sid!2sid"
