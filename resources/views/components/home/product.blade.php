<x-section-layout title="Products" :isCenter=true bgColor="bg-secondary/15">
        ...
        <div class="overflow-hidden">
            <div class="flex transition-transform py-8 md:py-12 duration-300 ease-in-out"
                ...
                <div class="w-full md:hidden flex-shrink-0">
                    <x-product-card image="{{ asset('images/product1.png') }}" title="Product 1" />
                </div>
                <div class="w-full md:hidden flex-shrink-0">
                    <x-product-card image="{{ asset('images/product2.png') }}" title="Product 2" />
                </div>
                <div class="w-full md:hidden flex-shrink-0">
                    <x-product-card image="{{ asset('images/product3.png') }}" title="Product 3" />
                </div>
                <div class="w-full md:hidden flex-shrink-0">
                    <x-product-card image="{{ asset('images/product4.png') }}" title="Product 4" />
                </div>
                <div class="w-full md:hidden flex-shrink-0">
                    <x-product-card image="{{ asset('images/product5.png') }}" title="Product 5" />
                </div>
                <div class="w-full md:hidden flex-shrink-0">
                    <x-product-card image="{{ asset('images/product6.png') }}" title="Product 6" />
                </div>
                <div class="w-full md:hidden flex-shrink-0">
                    <x-product-card image="{{ asset('images/product7.png') }}" title="Product 7" />
                </div>
                <div class="w-full md:hidden flex-shrink-0">
                    <x-product-card image="{{ asset('images/product8.png') }}" title="Product 8" />
                </div>
                <div class="w-full md:hidden flex-shrink-0">
                    <x-product-card image="{{ asset('images/product9.png') }}" title="Product 9" />
                </div>
                ...
                <div class="hidden md:block w-full flex-shrink-0">
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
                        <x-product-card image="{{ asset('images/product1.png') }}" title="Product 1" />
                        <x-product-card image="{{ asset('images/product2.png') }}" title="Product 2" class="sm:-translate-y-4 md:-translate-y-8" />
                        <x-product-card image="{{ asset('images/product3.png') }}" title="Product 3" />
                    </div>
                </div>
                ...
                <div class="hidden md:block w-full flex-shrink-0">
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
                        <x-product-card image="{{ asset('images/product4.png') }}" title="Product 4" />
                        <x-product-card image="{{ asset('images/product5.png') }}" title="Product 5" class="sm:-translate-y-4 md:-translate-y-8" />
                        <x-product-card image="{{ asset('images/product6.png') }}" title="Product 6" />
                    </div>
                </div>
                ...
                <div class="hidden md:block w-full flex-shrink-0">
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
                        <x-product-card image="{{ asset('images/product7.png') }}" title="Product 7" />
                        <x-product-card image="{{ asset('images/product8.png') }}" title="Product 8" class="sm:-translate-y-4 md:-translate-y-8" />
                        <x-product-card image="{{ asset('images/product9.png') }}" title="Product 9" />
                    </div>
                </div>
            </div>
