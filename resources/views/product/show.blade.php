<x-root-layout :categories="$categories">
    ...
    <section class="py-20">
        <div class="container">
            <div class="flex flex-col lg:flex-row gap-12 justify-between">
                <div class="w-full lg:w-1/2 rounded-sm bg-secondary/15 aspect-square">
                    <img src="{{ $product->picture }}" alt="Product 1" class="w-full h-full object-cover">
                </div>
                <div class="space-y-4 w-full lg:w-1/2">
                    <h2 class="text-3xl md:text-4xl lg:text-5xl text-primary font-black">{{ $product->productname }}</h2>
                    <div class="flex gap-4 items-center">
                        ...
                        {{-- end rating --}}
                        <p class="text-gray-500">40 reviews</p>
                    </div>
                    ...
                    <button class="bg-primary text-white px-4 py-2 rounded-md flex items-center gap-2">
    ...
    <section class="py-20 bg-secondary/15">
    ...
    <x-section-layout :title="'Special Offers'" :isCenter="true">
        ...
        <div x-data="{ currentSlide: 0 }" class="relative">
            <div class="overflow-hidden">
                <div class="flex transition-transform py-8 md:py-12 duration-300 ease-in-out"
                    ...
                    <div class="w-full md:hidden flex-shrink-0">
                        <x-product-card :image="$product->picture" :title="$product->productname" />
                    </div>
                    @endforeach
            ...
            <!-- Navigation buttons -->
            <button @click="currentSlide = (currentSlide - 1 + (window.innerWidth >= 768 ? Math.ceil(relatedProducts.length / 3) : relatedProducts.length)) % (window.innerWidth >= 768 ? Math.ceil(relatedProducts.length / 3) : relatedProducts.length)"
            ...
            <button @click="currentSlide = (currentSlide + 1) % (window.innerWidth >= 768 ? Math.ceil(relatedProducts.length / 3) : relatedProducts.length)"
            ...
            <div class="absolute -bottom-6 md:-bottom-8 left-1/2 transform -translate-x-1/2 flex space-x-1.5 md:space-x-2">
                <template x-for="(slide, index) in window.innerWidth >= 768 ? Array.from({length: Math.ceil(relatedProducts.length / 3)}) : Array.from({length: relatedProducts.length})" :key="index">
